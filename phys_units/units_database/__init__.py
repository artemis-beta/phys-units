...
epsilon_0 = pu.combined_units((m, kg, s, A), (-3, -1, 4, 2), 'permittivity of free space', 'epsilon_0', const=8.85418782E-12)
mu_0 = pu.combined_units((m, kg, s, A), (1, 1, -2, -2), 'permeability of free space', 'mu_0', const=1.25663706E-6)
R_H = pu.combined_units((m,), (-1,), 'Rydberg Constant', 'R_H', const=10973731.6)
pi  = pu.phys_float(pi)
c = pu.combined_units((m,s), (1,-2), 'speed of light in vacuum', 'c', const=299792458)
h = pu.combined_units((kg, m, s), (1,2,-1), 'Planck constant', 'h', const=6.626070040E-34)
...
N_A = pu.combined_units((mol,), (-1,), 'Avogadros Number', 'N_A', const=6.022140857E23)
k_B = pu.combined_units((kg, m, s, K), (1,2,-2,-1), 'Boltzmann constant', 'k_B', const=1.38064852E-23)
...
def simplify(comp_unit):
    for unit in all_cunits:
        ...
        if _match_keys:
            ...
            _other_indices = [-1*_factor*i for i in unit._components.values()]
            _match_indices_neg = list(comp_unit._components.values()) == _other_indices
